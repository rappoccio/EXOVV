...
ptbins =[  200., 260., 350., 460., 550., 650., 760., 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 13000.]
        ...
        for irecopt in xrange( len(ptbins) ):
            for irecom in xrange( len(mbins) ):
                ...
                if recom < recopt * 0.8 / math.sqrt(2.0) and genm < genpt * 0.8 / math.sqrt(2.0) :
                    if recobin == genbin :
                        diag += h2.GetBinContent(genbin, recobin)                
                    tot += h2.GetBinContent(genbin, recobin)
        if tot > 0.0001 :
            frac = diag / tot
        else :
            frac = 0
