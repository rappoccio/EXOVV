...
python execute_for_crab.py --makeResponseMatrix2D --isMC --doPDFs --xrootd root://cmsxrootd.fnal.gov/ --deweightFlat --applyTriggers --puStr CHS --metStr Full --btagger CSVv2 
