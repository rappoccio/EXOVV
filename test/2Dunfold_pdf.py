...
pdf_reco.Scale(1./pdf_reco.Integral("width"))
pdf_reco_softdrop.Scale(1./pdf_reco_softdrop.Integral("width"))

# get truth and normalize it
pdf_gen = pdffile.Get('PFJet_pt_m_AK8Gen')
pdf_gen_softdrop = pdffile.Get('PFJet_pt_m_AK8SDgen')
pdf_gen.Scale(1./pdf_gen.Integral("width"))
pdf_gen_softdrop.Scale(1./pdf_gen_softdrop.Integral("width"))
...
for i, canvas in enumerate(canvases_up) : 
    ...
    namesreco_up[i].Scale(1.0 / namesreco_up[i].Integral("width") )
...
for i, canvas in enumerate(canvases_up_softdrop):
    ...
    namesreco_up_softdrop[i].Scale( 1.0 / namesreco_up_softdrop[i].Integral("width") )
...
for i, canvas in enumerate(canvases_dn):
    ...
    namesreco_dn[i].Scale(1.0 / namesreco_dn[i].Integral("width") )
...
for i, canvas in enumerate(canvases_dn):
    ...
    namesreco_dn_softdrop[i].Scale( 1.0 / namesreco_dn_softdrop[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_up) : 
    ...
    namesreco_data_up[i].Scale( 1.0 / namesreco_data_up[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_up_softdrop):
    ...
    namesreco_data_up_softdrop[i].Scale( 1.0 / namesreco_data_up_softdrop[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_dn):
    ...
    namesreco_data_dn[i].Scale(1.0 / namesreco_data_dn[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_dn_softdrop):
    ...
    namesreco_data_dn_softdrop[i].Scale( 1.0 / namesreco_data_dn_softdrop[i].Integral("width") )
...
for i, canvas in enumerate(canvases_cteq) : 
    ...
    namesreco_cteq[i].Scale( 1.0 / namesreco_cteq[i].Integral("width") )
...
for i, canvas in enumerate(canvases_cteq_softdrop):
    ...
    namesreco_cteq_softdrop[i].Scale( 1.0 / namesreco_cteq_softdrop[i].Integral("width") )
...
for i, canvas in enumerate(canvases_mstw) : 
    ...
    namesreco_mstw[i].Scale(1.0 / namesreco_mstw[i].Integral("width") )
...
for i, canvas in enumerate(canvases_mstw_softdrop):
    ...
    namesreco_mstw_softdrop[i].Scale( 1.0 / namesreco_mstw_softdrop[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_cteq) : 
    ...
    namesreco_data_cteq[i].Scale( 1.0 / namesreco_data_cteq[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_cteq_softdrop):
    ...
    namesreco_data_cteq_softdrop[i].Scale( 1.0 / namesreco_data_cteq_softdrop[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_mstw) : 
    ...
    namesreco_data_mstw[i].Scale( 1.0 / namesreco_data_mstw[i].Integral("width") )
...
for i, canvas in enumerate(canvases_data_mstw_softdrop):
    ...
    namesreco_data_mstw_softdrop[i].Scale( 1.0 / namesreco_data_mstw_softdrop[i].Integral("width") )
