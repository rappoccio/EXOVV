...
python execute_for_crab.py --makeResponseMatrix2D --isMC --doPDFs --xrootd root://cmsxrootd.fnal.gov/ --applyTriggers --deweightFlat --puStr CHS --metStr Full --btagger CSVv2 
