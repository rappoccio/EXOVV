...
def JetTreeDump_FWLite(argv) :
    ...
    l_jetsAK8Pt = ("jetsAK8Puppi" , "jetAK8PuppiPt") #
    h_jetsAK8Eta = Handle("std::vector<float>")
    l_jetsAK8Eta = ("jetsAK8Puppi" , "jetAK8PuppiEta")
    h_jetsAK8Phi = Handle("std::vector<float>")
    l_jetsAK8Phi = ("jetsAK8Puppi" , "jetAK8PuppiPhi")
    h_jetsAK8Mass = Handle("std::vector<float>")
    l_jetsAK8Mass = ("jetsAK8Puppi" , "jetAK8PuppiMass")
    h_jetsAK8Energy = Handle("std::vector<float>")
    l_jetsAK8Energy = ("jetsAK8Puppi" , "jetAK8PuppiE")
    h_jetsAK8JEC = Handle("std::vector<float>")
    l_jetsAK8JEC = ("jetsAK8Puppi" , "jetAK8PuppijecFactor0")
    h_jetsAK8Y = Handle("std::vector<float>")
    l_jetsAK8Y = ("jetsAK8Puppi" , "jetAK8PuppiY")

    h_jetsAK8nHadEnergy = Handle("std::vector<float>")
    l_jetsAK8nHadEnergy = ("jetsAK8Puppi" , "jetAK8PuppineutralHadronEnergy")
    h_jetsAK8nEMEnergy = Handle("std::vector<float>")
    l_jetsAK8nEMEnergy = ("jetsAK8Puppi" , "jetAK8PuppineutralEmEnergy")
    h_jetsAK8HFHadronEnergy = Handle("std::vector<float>")
    l_jetsAK8HFHadronEnergy = ("jetsAK8Puppi" , "jetAK8PuppiHFHadronEnergy")
    h_jetsAK8cHadEnergy = Handle("std::vector<float>")
    l_jetsAK8cHadEnergy = ("jetsAK8Puppi" , "jetAK8PuppichargedHadronEnergy")
    h_jetsAK8cEMEnergy = Handle("std::vector<float>")
    l_jetsAK8cEMEnergy = ("jetsAK8Puppi" , "jetAK8PuppichargedEmEnergy")
    h_jetsAK8numDaughters = Handle("std::vector<float>")
    l_jetsAK8numDaughters = ("jetsAK8Puppi" , "jetAK8PuppinumberOfDaughters")
    h_jetsAK8cMultip = Handle("std::vector<float>")
    l_jetsAK8cMultip = ("jetsAK8Puppi" , "jetAK8PuppichargedMultiplicity")
    h_jetsAK8Y = Handle("std::vector<float>")
    l_jetsAK8Y = ("jetsAK8Puppi" , "jetAK8PuppiY")
    ...
    l_jetsAK8SoftDropMass = ("jetsAK8Puppi", "jetAK8PuppisoftDropMass" )
    h_jetsAK8TrimMass = Handle("std::vector<float>")
    l_jetsAK8TrimMass = ("jetsAK8Puppi", "jetAK8PuppitrimmedMass" )
    h_jetsAK8PrunMass = Handle("std::vector<float>")
    l_jetsAK8PrunMass = ("jetsAK8Puppi", "jetAK8PuppiprunedMass" )
    h_jetsAK8FiltMass = Handle("std::vector<float>")
    l_jetsAK8FiltMass = ("jetsAK8Puppi", "jetAK8PuppifilteredMass" )
    h_jetsAK8Tau1 = Handle("std::vector<float>")
    l_jetsAK8Tau1 = ("jetsAK8Puppi", "jetAK8Puppitau1" )
    h_jetsAK8Tau2 = Handle("std::vector<float>")
    l_jetsAK8Tau2 = ("jetsAK8Puppi", "jetAK8Puppitau2" )
    h_jetsAK8Tau3 = Handle("std::vector<float>")
    l_jetsAK8Tau3 = ("jetsAK8Puppi", "jetAK8Puppitau3" )
    h_jetsAK8Area = Handle("std::vector<float>")
    l_jetsAK8Area = ( "jetsAK8Puppi" , "jetAK8PuppijetArea" )


    h_jetsAK8vSubjetIndex0 = Handle("std::vector<float>")
    l_jetsAK8vSubjetIndex0 = ("jetsAK8Puppi", "jetAK8PuppivSubjetIndex0")
    h_jetsAK8vSubjetIndex1 = Handle("std::vector<float>")
    l_jetsAK8vSubjetIndex1 = ("jetsAK8Puppi", "jetAK8PuppivSubjetIndex1")

    h_subjetsAK8Pt = Handle( "std::vector<float>")
    l_subjetsAK8Pt = ("subjetsAK8Puppi", "subjetAK8PuppiPt")
    h_subjetsAK8Eta = Handle( "std::vector<float>")
    l_subjetsAK8Eta = ("subjetsAK8Puppi", "subjetAK8PuppiEta")
    h_subjetsAK8Phi = Handle( "std::vector<float>")
    l_subjetsAK8Phi = ("subjetsAK8Puppi", "subjetAK8PuppiPhi")
    h_subjetsAK8Mass = Handle( "std::vector<float>")
    l_subjetsAK8Mass = ("subjetsAK8Puppi", "subjetAK8PuppiMass")
    h_subjetsAK8BDisc = Handle( "std::vector<float>")
    l_subjetsAK8BDisc = ("subjetsAK8Puppi", "subjetAK8PuppiCSVv2")
    ...
    for ifile in files : #{ Loop over root files
        ...
        for event in events: #{ Loop over events in root files
            ...
            if not options.isMC and options.applyTriggers and readTriggers :
