...
plot_vars(datacanvases, datalist, jecupa, jecdna, jerupa, jerdna, jernoma, ps_differences, pdf_differences, alegends, "mcvariations_PAS_"+postfix, jmrupa, jmrdna, jmrnoma, puupa, pudna, bins, keephists=histstokeep, jackknifeRMS=RMS_vals, outfile=True)
plot_vars(datacanvasesSD, datalistSD, jecupaSD, jecdnaSD, jerupaSD, jerdnaSD, jernomaSD, ps_differences_softdrop, pdf_differences_softdrop, alegendsSD, "mcvariations_softdrop_PAS_"+postfix, jmrupaSD, jmrdnaSD, jmrnomaSD, puupaSD, pudnaSD, bins, softdrop="MMDT Beta=0", keephists=histstokeep, jackknifeRMS=RMS_vals_softdrop, histname="Soft Drop ", outfile=True)
